    ...
    for filename in filenames:
        ...
        if os.path.exists(filename):
                ...
                for subdir, dirs, files in os.walk(tmp_path):
                    for file in files:
                        ...
                        if filepath.endswith(".csv"):
                            feedwatch_parser.parse_file(args.TEST, args.farm_id, filepath, db_engine)
            ...
            # if it's not a tar, just parse
                ...
                feedwatch_parser.parse_file(args.TEST, args.farm_id, filename, db_engine)
        else:
